...
class PagamentoTipoField extends StatelessWidget {
  //Atributos
  final List<PagamentoTipoModel> tiposPagamentos;
  final ValueChanged<int> valueChanged;
  final bool valido;
  final String valueSelected;

  //Constutor
  const PagamentoTipoField({
    super.key,
    required this.tiposPagamentos,
        ...
        children: [
          ...
          SmartSelect<String>.single(
            ...
            choiceItems: S2Choice.listFrom<String, Map<String, String>>(
              source: tiposPagamentos
                  .map((e) =>
                      {'value': e.id.toString(), 'title': e.name.toString()})
                  .toList(),
